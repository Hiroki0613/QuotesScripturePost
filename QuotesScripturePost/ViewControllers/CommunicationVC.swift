...
class CommunicationVC: UIViewController {
    ...
    //        shareButton.translatesAutoresizingMaskIntoConstraints = false
            ...
            NSLayoutConstraint.activate([
                ...
                commentLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: padding),
                commentLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -padding),
